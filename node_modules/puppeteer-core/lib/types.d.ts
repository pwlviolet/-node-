 ...
 * @internal
 */
declare class ChromeLauncher implements ProductLauncher {
    /**
     * @internal
     */
...
export declare function computeQuadArea(quad: Point[]): number;
 ...
 * @internal
 */
declare class FirefoxLauncher implements ProductLauncher {
    /**
     * @internal
     */
    _projectRoot: string | undefined;
...
declare type FlattenHandle<T> = T extends HandleOr<infer U> ? U : never;
...
export declare class HTTPRequest {
     ...
     * @internal
     */
    constructor(client: CDPSession_4, frame: Frame | null, interceptionId: string | undefined, allowInterception: boolean, event: Protocol.Network.RequestWillBeSentEvent, redirectChain: HTTPRequest[]);
    /**
...
export declare class HTTPResponse {
    ...
    export declare class JSHandle<T = unknown> {
        ...
        this,
        ...Params
        ]>>(pageFunction: Func, ...args: Params): Promise<HandleFor<Awaited<ReturnType<Func>>>>;
        /**
    ...
    export declare class Page extends EventEmitter {
         ...
         * @internal
         */
        static _create(client: CDPSession, target: Target, ignoreHTTPSErrors: boolean, defaultViewport: Viewport | null, screenshotTaskQueue: TaskQueue): Promise<Page>;
        /**
         * @internal
         */
